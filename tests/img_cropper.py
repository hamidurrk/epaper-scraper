...
image_path = "C:\\Users\\hamid\\OneDrive\\Documents\\epaper-scraper\\tests\\ori2.jpg"
image = Image.open(image_path)

image_width, image_height = image.size

# Extract div elements with class "pagerectangle"
...
# Draw rectangles on the image based on style attributes
...
for i, div in enumerate(div_elements):
    ...
    cropped_image.save(os.path.join(output_directory, f"cropped_image_{i}.jpg"))
    
    # Add scaled rectangle coordinates to the list
