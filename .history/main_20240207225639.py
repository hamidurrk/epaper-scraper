...
driver = webdriver.Firefox(executable_path='/Users/hamid/OneDrive/Documents/geckodriver.exe', options=firefox_options, service_args = ['--marionette-port', '2828', '--connect-existing'])
...
def main():
    ...
    # Scrape image URLs
    driver.get(url)
    image_elements = driver.find_elements_by_css_selector(".newsImg")
