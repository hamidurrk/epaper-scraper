...
def main():
    ...
    # pages = driver.find_element_by_xpath("//ul[contains(@class,'jPag-pages')]")
    # print(pages)
    ...
    # Get the number of <li> elements (which corresponds to the number of elements within the <ul> tag)
    num_elements = len(li_elements)

    print(f"Number of elements within the <ul> tag: {num_elements}")
