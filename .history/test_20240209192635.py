...
for i in range(1, num_pages):
    num_articles = (os.listdir(os.path.join(BASE_DIR, "downloaded_articles", "jugantor", year, month, day, f"page_{i}")))
    print(num_articles)
    # for j in range(1, num_articles):
        # os.path.join(BASE_DIR, "downloaded_articles", "jugantor", year, month, day, f"page_{i}", article)
