...
def scrape_recent_jugantor(year: str, month: str, day: str):
    ...
    print("Number of <li> elements:", num_pages)
    
    map_element = driver.find_element_by_id("imgmap202431701120")

    # Find all the area elements within the map
    area_elements = map_element.find_elements_by_tag_name("area")

    # Extract the href attribute of each area element
    image_urls = [area.get_attribute("href") for area in area_elements]
