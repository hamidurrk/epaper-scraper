...
def main():
    ...
    # Scrape image URLs
    driver.get(url)
    image_elements = driver.find_element_by_xpath("/html/body/div[2]/table/tbody/tr[1]/td/div/table/tbody/tr/td[2]/div/table/tbody/tr/td[1]/div[2]/div/table/tbody/tr[3]/td[2]/a/img")
