...
print (pytesseract.pytesseract.image_to_string(Image.open('C:/Users/hamid/OneDrive/Documents/epaper-scraper/downloaded_articles/jugantor/2020/07/27/page_10/article_13.jpg'), lang='ben'))